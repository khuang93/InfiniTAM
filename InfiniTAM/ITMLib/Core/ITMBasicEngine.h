...
namespace ITMLib
{
	...
	public:
		...
		void SetScene(ITMScene<TVoxel,TIndex>* _scene){scene=_scene;}
		...
		//new
	  	ITMTrackingState::TrackingResult ProcessFrame(ITMUChar4Image *rgbImage, ITMFloatImage *depthImage, ITMIMUMeasurement *imuMeasurement = NULL);
