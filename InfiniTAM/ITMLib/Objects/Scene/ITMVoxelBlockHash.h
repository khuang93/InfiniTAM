...
#define SDF_LOCAL_BLOCK_NUM 0x40000		// 0x40000 0x20000Number of locally stored blocks, currently 2^17

#define SDF_BUCKET_NUM 0x100000			// 0x100000 0x80000Number of Hash Bucket, should be 2^n and bigger than SDF_LOCAL_BLOCK_NUM, SDF_HASH_MASK = SDF_BUCKET_NUM - 1
#define SDF_HASH_MASK 0xffffff		// 0xffffff 0x7ffffUsed for get hashing value of the bucket index,  SDF_HASH_MASK = SDF_BUCKET_NUM - 1
#define SDF_EXCESS_LIST_SIZE 0x20000	// 0x20000 0x10000Size of excess list, used to handle collisions. Also max offset (unsigned short) value.
